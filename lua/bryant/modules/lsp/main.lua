...
require "bryant.modules.lsp.installer"
require "bryant.modules.lsp.config"
local capabilities = require "bryant.modules.lsp.capabilities"

-- Creating a function call on_attach
local function on_attach(client, bufnr)
    require("bryant.modules.lsp.on_attach").setup(client, bufnr)
end
