...
map("n", "<leader>sb", function()
    require("bryant.core.utils").swap_boolean()
end)
...
map("n", "<A-r>", function()
    require("bryant.core.utils").rename()
end)

map("n", "l", function()
    require("bryant.core.utils").l_motion()
end)
map("n", "h", function()
    require("bryant.core.utils").h_motion()
end)
map("n", "<leader>,", function()
    require("bryant.core.utils").insert_comma()
end)
map("n", "<leader>;", function()
    require("bryant.core.utils").insert_semicolon()
end)
...
map("n", "<leader>lr", function()
    require("bryant.core.utils").open()
end)
...
map("n", "<leader>lbh", function()
    require("bryant.core.utils").show_documentation()
...
map("n", "<leader>ff", function()
    require("bryant.modules.files.telescope").find_files()
    -- require("telescope.builtin").find_files()
end)
map("n", "<leader>fw", function()
    require("bryant.modules.files.telescope").live_grep()
    -- require("telescope.builtin").live_grep()
end)
map("n", "<leader>fd", function()
    require("bryant.modules.files.telescope").diag()
    -- require("telescope.builtin").diagnostics()
end)
map("n", "<C-p>", function()
    require("bryant.modules.files.telescope").buffers()
...
map("n", "<leader>ft", function()
    require("bryant.modules.files.telescope").harpoon()
end)
